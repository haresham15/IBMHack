...
export default function Home() {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: 'linear-gradient(180deg, #4A90C4 0%, #1B5E8A 100%)',
      ...
      <div style={{ textAlign: 'center', maxWidth: '480px', width: '100%' }}>
        ...
        <div style={{ fontSize: '18px', color: '#BAE0F5', marginBottom: '48px', lineHeight: 1.5 }}>
        ...
        <div style={{ marginTop: '24px', fontSize: '12px', color: '#BAE0F5' }}>
